...
router.post('/signup', authLimiter, registerValidation, validateRequest, register);
router.post('/login', authLimiter, loginValidation, validateRequest, login);
router.post('/social', authLimiter, socialAuthValidation, validateRequest, socialAuth);
