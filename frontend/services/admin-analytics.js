...
async function loadAdminAnalytics() {
  ...
  try {
    ...
    const additionalMetrics = stats?.metrics || {};
    ...
    const metrics = [
      ...
      { label: "Total Food Quantity (Servings)", value: additionalMetrics.totalFoodQuantity || 0 },
      { label: "Active Volunteers", value: userStats.activeVolunteers || 0 },
      { label: "Deliveries Completed", value: additionalMetrics.deliveriesCompleted || 0 },
      { label: "Total Categories", value: Array.isArray(additionalMetrics.categoryDistribution) ? additionalMetrics.categoryDistribution.length : 0 },
      { label: "Cities Reached", value: Array.isArray(additionalMetrics.cityDistribution) ? additionalMetrics.cityDistribution.length : 0 }
    ];
